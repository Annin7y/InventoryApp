        ...
        LoaderManager.LoaderCallbacks<Cursor>
{
        ...
        * There is no inventory data yet (until the loader finishes) so pass in null for the Cursor.
        ...
        inventoryListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id)
            {
                ...
                // Launch the {@link EditorActivity} to display the data for the current inventory selection.
                startActivity(intent);
            }
        });
    ...
    private void insertInventory()
    {
        ...
        values.put(InventoryEntry.COLUMN_SHOES_SIZE, InventoryEntry.SIZE_NINE);
