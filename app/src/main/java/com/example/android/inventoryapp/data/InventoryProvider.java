...
public class InventoryProvider extends ContentProvider
{
    ...
    /**
     * URI matcher code for the content URI for a single pair of shoes in the shoes table
     */
    ...
    static
    {
        ...
        //
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_SHOES + "/#", SHOE_ID);
    }
